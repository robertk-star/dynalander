...
export const mainStyle: CSSProperties = { padding: 32, overflowX: 'auto' };
...
export const inputStyle: CSSProperties = { width: '100%', padding: '12px 12px', borderRadius: 10, border: '1px solid #cbd5e1', fontSize: 14, boxSizing: 'border-box' };

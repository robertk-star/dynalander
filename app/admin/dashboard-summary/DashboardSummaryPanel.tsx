...
function CampaignTable({ rows }: { rows: Row[] }) {
  return <section style={cardStyle}><h2 style={{ marginTop: 0 }}>Campaign summary</h2><table style={tableStyle}><thead><tr><th style={thTdStyle}>Campaign</th><th style={thTdStyle}>Campaign ID</th><th style={thTdStyle}>Results</th><th style={thTdStyle}>Spend</th><th style={thTdStyle}>Impressions</th><th style={thTdStyle}>Clicks</th><th style={thTdStyle}>CTR</th><th style={thTdStyle}>CPC</th><th style={thTdStyle}>CPM</th></tr></thead><tbody>{rows.map((row) => <tr key={`campaign-${row.id}`}><td style={thTdStyle}>{row.name}</td><td style={thTdStyle}>{row.id}</td><td style={thTdStyle}>{row.results}</td><td style={thTdStyle}>{row.spend}</td><td style={thTdStyle}>{row.impressions}</td><td style={thTdStyle}>{row.clicks}</td><td style={thTdStyle}>{row.ctr}</td><td style={thTdStyle}>{row.cpc}</td><td style={thTdStyle}>{row.cpm}</td></tr>)}</tbody></table>{rows.length === 0 ? <p style={{ color: '#64748b' }}>No campaign rows returned for the selected date range.</p> : null}</section>;
}

function AdSetTable({ rows }: { rows: Row[] }) {
  return <section style={cardStyle}><h2 style={{ marginTop: 0 }}>Ad set summary</h2><table style={tableStyle}><thead><tr><th style={thTdStyle}>Campaign</th><th style={thTdStyle}>Ad set</th><th style={thTdStyle}>Ad set ID</th><th style={thTdStyle}>Results</th><th style={thTdStyle}>Spend</th><th style={thTdStyle}>Impressions</th><th style={thTdStyle}>Clicks</th><th style={thTdStyle}>CTR</th><th style={thTdStyle}>CPC</th><th style={thTdStyle}>CPM</th></tr></thead><tbody>{rows.map((row) => <tr key={`adset-${row.id}`}><td style={thTdStyle}>{row.campaignName || '—'}</td><td style={thTdStyle}>{row.name}</td><td style={thTdStyle}>{row.id}</td><td style={thTdStyle}>{row.results}</td><td style={thTdStyle}>{row.spend}</td><td style={thTdStyle}>{row.impressions}</td><td style={thTdStyle}>{row.clicks}</td><td style={thTdStyle}>{row.ctr}</td><td style={thTdStyle}>{row.cpc}</td><td style={thTdStyle}>{row.cpm}</td></tr>)}</tbody></table>{rows.length === 0 ? <p style={{ color: '#64748b' }}>No ad set rows returned for the selected date range.</p> : null}</section>;
}

function AdTable({ rows }: { rows: Row[] }) {
  return <section style={cardStyle}><h2 style={{ marginTop: 0 }}>Ad summary</h2><table style={tableStyle}><thead><tr><th style={thTdStyle}>Campaign</th><th style={thTdStyle}>Ad set</th><th style={thTdStyle}>Ad</th><th style={thTdStyle}>Ad ID</th><th style={thTdStyle}>Results</th><th style={thTdStyle}>Spend</th><th style={thTdStyle}>Impressions</th><th style={thTdStyle}>Clicks</th><th style={thTdStyle}>CTR</th><th style={thTdStyle}>CPC</th><th style={thTdStyle}>CPM</th></tr></thead><tbody>{rows.map((row) => <tr key={`ad-${row.id}`}><td style={thTdStyle}>{row.campaignName || '—'}</td><td style={thTdStyle}>{row.adSetName || '—'}</td><td style={thTdStyle}>{row.name}</td><td style={thTdStyle}>{row.id}</td><td style={thTdStyle}>{row.results}</td><td style={thTdStyle}>{row.spend}</td><td style={thTdStyle}>{row.impressions}</td><td style={thTdStyle}>{row.clicks}</td><td style={thTdStyle}>{row.ctr}</td><td style={thTdStyle}>{row.cpc}</td><td style={thTdStyle}>{row.cpm}</td></tr>)}</tbody></table>{rows.length === 0 ? <p style={{ color: '#64748b' }}>No ad rows returned for the selected date range.</p> : null}</section>;
}
...
function AdDeviceSummary({ summaryRows, detailRows, warning }: { summaryRows: DeviceSummary[]; detailRows: DeviceRow[]; warning?: string | null }) {
  return <section style={cardStyle}><h2 style={{ marginTop: 0 }}>Ad summary by device</h2><p style={{ color: '#64748b' }}>Ad-level performance grouped by Meta impression device. Phones and tablets are grouped as Mobile. Desktop is shown separately.</p>{warning ? <p style={{ color: '#9a3412', fontWeight: 800 }}>{warning}</p> : null}<div style={gridStyle}>{summaryRows.map((row) => <div key={`device-card-${row.device}`} style={cardStyle}><div style={{ color: '#64748b' }}>{row.device}</div><strong style={{ fontSize: 30 }}>{row.results}</strong><p style={{ marginBottom: 0, color: '#64748b' }}>Results</p><p style={{ marginBottom: 0 }}><strong>{row.spend}</strong> spend · {row.clicks} clicks · {row.ctr} CTR</p></div>)}</div><table style={tableStyle}><thead><tr><th style={thTdStyle}>Device</th><th style={thTdStyle}>Ad</th><th style={thTdStyle}>Ad set</th><th style={thTdStyle}>Campaign</th><th style={thTdStyle}>Results</th><th style={thTdStyle}>Spend</th><th style={thTdStyle}>Impressions</th><th style={thTdStyle}>Clicks</th><th style={thTdStyle}>CTR</th><th style={thTdStyle}>CPC</th><th style={thTdStyle}>CPM</th></tr></thead><tbody>{detailRows.map((row) => <tr key={row.id}><td style={thTdStyle}>{row.device}<div style={{ color: '#64748b', fontSize: 12 }}>{row.rawDevice}</div></td><td style={thTdStyle}>{row.adName}</td><td style={thTdStyle}>{row.adSetName}</td><td style={thTdStyle}>{row.campaignName}</td><td style={thTdStyle}>{row.results}</td><td style={thTdStyle}>{row.spend}</td><td style={thTdStyle}>{row.impressions}</td><td style={thTdStyle}>{row.clicks}</td><td style={thTdStyle}>{row.ctr}</td><td style={thTdStyle}>{row.cpc}</td><td style={thTdStyle}>{row.cpm}</td></tr>)}</tbody></table>{summaryRows.length === 0 ? <p style={{ color: '#64748b' }}>No mobile/desktop breakdown rows returned for the selected date range.</p> : null}</section>;
}
  ...
  return (
    <>
      <section style={{ ...cardStyle, border: data?.ok ? '2px solid #0f766e' : '2px solid #f97316', background: data?.ok ? '#f0fdfa' : '#fff7ed' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, alignItems: 'center' }}><div><h2 style={{ marginTop: 0 }}>Connection and refresh status</h2><p style={{ color: data?.ok ? '#0f766e' : '#9a3412', fontWeight: 800, lineHeight: 1.6, marginBottom: 0 }}>{data?.ok ? `Connected to ${selectedAccount.name}. Last refresh was ${lastRefresh ?? 0} min ago.` : data?.error || `Not connected for ${selectedAccount.name}.`}</p></div><button type="button" onClick={loadData} style={blueButtonStyle}>{loading ? 'Refreshing...' : 'Refresh summary'}</button></div>
      </section>
      <section style={cardStyle}>
        <h2 style={{ marginTop: 0 }}>Summary information</h2>
        <div style={twoColumnStyle}><label style={labelStyle}>Date range<select style={inputStyle} value={range} onChange={(event) => setRange(event.target.value as RangeKey)}><option value="today">Today</option><option value="yesterday">Yesterday</option><option value="last_7d">Last 7 days</option><option value="this_month">This month</option><option value="last_month">Last month</option><option value="custom">Custom date</option></select></label>{range === 'custom' ? <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}><label style={labelStyle}>Start<input style={inputStyle} type="date" value={start} onChange={(event) => setStart(event.target.value)} /></label><label style={labelStyle}>End<input style={inputStyle} type="date" value={end} onChange={(event) => setEnd(event.target.value)} /></label></div> : <div><strong>{data?.range?.label || 'Last 7 days'}</strong><p style={{ color: '#64748b', marginBottom: 0 }}>{data?.range ? `${data.range.since} to ${data.range.until}` : 'Waiting for data.'}</p><p style={{ color: '#64748b', marginBottom: 0 }}>{data?.range?.timeZone || 'America/Chicago'}</p></div>}</div>
      ...
      <div style={gridStyle}><div style={cardStyle}><div style={{ color: '#64748b' }}>Results</div><strong style={{ fontSize: 34 }}>{summary?.results || '—'}</strong></div><div style={cardStyle}><div style={{ color: '#64748b' }}>Spend</div><strong style={{ fontSize: 34 }}>{summary?.spend || '—'}</strong></div><div style={cardStyle}><div style={{ color: '#64748b' }}>Impressions</div><strong style={{ fontSize: 34 }}>{summary?.impressions || '—'}</strong></div><div style={cardStyle}><div style={{ color: '#64748b' }}>Clicks</div><strong style={{ fontSize: 34 }}>{summary?.clicks || '—'}</strong></div><div style={cardStyle}><div style={{ color: '#64748b' }}>CTR</div><strong style={{ fontSize: 34 }}>{summary?.ctr || '—'}</strong></div><div style={cardStyle}><div style={{ color: '#64748b' }}>CPC / CPM</div><strong style={{ fontSize: 34 }}>{summary ? `${summary.cpc} / ${summary.cpm}` : '—'}</strong></div></div>
